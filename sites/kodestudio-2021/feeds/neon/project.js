...
rtl.module("kode",["System","browserapp","JS","Classes","SysUtils","Web"],function () {
  "use strict";
  var $mod = this;
  this.create = function (parent, ele, input) {
...
rtl.module("program",["System","browserapp","JS","Classes","SysUtils","Web","kode"],function () {
  "use strict";
  var $mod = this;
  $mod.$main = function () {
    pas.kode.create("main","div","");
    pas.System.Writeln("hallo");
  };
});
