...
rtl.module("kodedom",["System","JS","SysUtils","browserapp"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass($mod,"dom",pas.System.TObject,function () {
    this.setInnerHtml = function (id, content) {
      document.getElementById(id).innerHTML = content;
    };
    this.getValueHtml = function (id) {
      var Result = "";
      var temp = "";
      temp = "";
    ...
    this.setValuehtml = function (id, content) {
      document.getElementById(id).value = content;
    };
  });
});
rtl.module("kodefirebase",["System","JS","SysUtils","browserapp"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass($mod,"firebase",pas.System.TObject,function () {
    this.pushData = function (path, map) {
      firebase.database().ref(path).push(map);
    };
  });
});
rtl.module("kodestorage",["System","JS","SysUtils","browserapp","kodedom"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass($mod,"localStorage",pas.System.TObject,function () {
...
rtl.module("program",["System","SysUtils","JS","browserapp","kodedom","kodefirebase","kodestorage"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass($mod,"message",pas.System.TObject,function () {
    this.$init = function () {
  ...
  this.storage = null;
  this.mess = null;
  this.loading = function (code) {
    var $tmp = code;
    if ($tmp === "init") {
      pas.System.Writeln("Loading()");
      return;
    } else if ($tmp === "run") {
      $mod.obj.setValuehtml("input_name",$mod.storage.getValue("tempName"));
      $mod.obj.setValuehtml("input_roomid",$mod.storage.getValue("tempCode"));
    } else if ($tmp === "stop") {
      return}
     else {
      pas.System.Writeln("No code to start function");
      return;
    };
  };
  this.jump = function (code) {
    var $tmp = code;
    if ($tmp === "init") {
      pas.System.Writeln("Jump()");
      return;
    } else if ($tmp === "run") {
      if ($mod.obj.getValueHtml("input_name") !== "") {
        if ($mod.obj.getValueHtml("input_roomid") !== "") {
          document.getElementById("button_jump").disabled = true;
          $mod.mess.from = $mod.obj.getValueHtml("input_name");
          $mod.mess.message = $mod.obj.getValueHtml("input_roomid");
          $mod.mess.code = $mod.obj.getValueHtml("input_roomid");
  ...
  $mod.$main = function () {
    $mod.obj = pas.kodedom.dom.$create("Create");
    $mod.fire = pas.kodefirebase.firebase.$create("Create");
    $mod.storage = pas.kodestorage.localStorage.$create("Create");
    $mod.mess = $mod.message.$create("Create");
    $mod.loading("init");
    $mod.loading("run");
    $mod.jump("init");
  };
